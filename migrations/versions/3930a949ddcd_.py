...
Revision ID: 3930a949ddcd
Revises: 
Create Date: 2020-09-23 20:39:16.753175
...
def upgrade():
    ...
    op.create_index(op.f('ix_ext_user_email'), 'ext_user', ['email'], unique=True)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_ext_user_email'), table_name='ext_user')
    op.drop_table('ext_user')
    # ### end Alembic commands ###
